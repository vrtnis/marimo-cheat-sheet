...
def __(mo):
    ...
    mo.hstack([
        mo.vstack([
            ...
            mo.md(f"## {mo.icon('lucide:download')} Install and Import"),
            mo.md("""
            ...
            ```
            """),
            mo.md(f"## {mo.icon('lucide:arrow-down-square')} Markdown"),
            mo.md("""
            ...
            ```
            """),
            mo.md(f"## {mo.icon('lucide:layout-dashboard')} Layout"),
            ...
            mo.md(f"## {mo.icon('lucide:keyboard')} Inputs"),
            mo.md("""
        ...
        mo.vstack([
            ...
            mo.md(f"## {mo.icon('lucide:scatter-chart')} Plotting"),
            ...
            ```
            """),
            mo.md(f"## {mo.icon('lucide:play-square')} Media"),
            ...
            mo.md(f"## {mo.icon('lucide:shapes')} Diagrams"),
            ...
            ```
            """),
            mo.md(f"## {mo.icon('lucide:circle-dashed')} Status"),
            mo.md("""
        ...
        mo.vstack([
            mo.md(f"## {mo.icon('lucide:arrow-big-right-dash')} Outputs"),
            ...
            """),
                        mo.md(f"## {mo.icon('lucide:code-2')} HTML"),
        ...
        mo.vstack([
            ...
            mo.md(f"## {mo.icon('lucide:arrow-down-up')} Control Flow"),
            ...
            mo.md(f"## {mo.icon('lucide:orbit')} State"),
            ...
            ```
            """),
            mo.md(f"## {mo.icon('lucide:bug-off')} Debug"),
            mo.md("""
            ...
            mo.md(f"### {mo.icon('lucide:github')} https://github.com/vrtnis/marimo-cheat-sheet"),
            mo.md(f"### {mo.icon('lucide:book-open-text')} Always check https://docs.marimo.io")
